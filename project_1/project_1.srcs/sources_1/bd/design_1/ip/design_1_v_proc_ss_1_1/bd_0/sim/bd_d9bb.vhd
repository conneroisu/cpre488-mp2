...
----------------------------------------------------------------------------------
--Command: generate_target bd_d9bb.bd
--Design : bd_d9bb
...
entity bd_d9bb is
  ...
  attribute CORE_GENERATION_INFO of bd_d9bb : entity is "bd_d9bb,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_d9bb,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_d9bb : entity is "design_1_v_proc_ss_1_1.hwdef";
end bd_d9bb;

architecture STRUCTURE of bd_d9bb is
  component bd_d9bb_hcr_0 is
  port (
    s_axi_CTRL_AWADDR : in STD_LOGIC_VECTOR ( 10 downto 0 );
    s_axi_CTRL_AWVALID : in STD_LOGIC;
    s_axi_CTRL_AWREADY : out STD_LOGIC;
