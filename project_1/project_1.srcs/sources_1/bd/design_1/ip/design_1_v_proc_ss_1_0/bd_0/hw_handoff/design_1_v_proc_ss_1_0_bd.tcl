...
################################################################
# This is a generated script based on design: bd_197a
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net intf_net_smartconnect_0_M05_AXI [get_bd_intf_pins hcr/s_axi_CTRL] [get_bd_intf_pins smartconnect_0/M05_AXI]
  ...
  assign_bd_address -offset 0x00010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces s_axi_ctrl] [get_bd_addr_segs hcr/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x00020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces s_axi_ctrl] [get_bd_addr_segs hsc/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x00030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces s_axi_ctrl] [get_bd_addr_segs ltr/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x00040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces s_axi_ctrl] [get_bd_addr_segs reset_sel_axis/S_AXI/Reg] -force
  assign_bd_address -offset 0x00060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces s_axi_ctrl] [get_bd_addr_segs vsc/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x00050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces s_axi_ctrl] [get_bd_addr_segs video_router/xbar/S_AXI_CTRL/Reg] -force
