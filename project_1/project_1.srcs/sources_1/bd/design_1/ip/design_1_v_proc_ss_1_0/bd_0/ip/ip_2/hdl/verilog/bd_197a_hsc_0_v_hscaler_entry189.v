...
module bd_197a_hsc_0_v_hscaler_entry189 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
        ...
        HwReg_ColorMode_out1_din,
        HwReg_ColorMode_out1_full_n,
        HwReg_ColorMode_out1_write,
        HwReg_ColorModeOut_out_din,
        HwReg_ColorModeOut_out_full_n,
        HwReg_ColorModeOut_out_write,
        HwReg_ColorModeOut_out2_din,
        HwReg_ColorModeOut_out2_full_n,
        HwReg_ColorModeOut_out2_write
);
...
output  [15:0] HwReg_WidthIn_out_din;
...
output  [7:0] HwReg_ColorMode_out1_din;
input   HwReg_ColorMode_out1_full_n;
output   HwReg_ColorMode_out1_write;
output  [7:0] HwReg_ColorModeOut_out_din;
input   HwReg_ColorModeOut_out_full_n;
output   HwReg_ColorModeOut_out_write;
output  [7:0] HwReg_ColorModeOut_out2_din;
input   HwReg_ColorModeOut_out2_full_n;
output   HwReg_ColorModeOut_out2_write;
...
reg HwReg_ColorMode_out1_write;
reg HwReg_ColorModeOut_out_write;
reg HwReg_ColorModeOut_out2_write;
...
reg    HwReg_ColorMode_out1_blk_n;
reg    HwReg_ColorModeOut_out_blk_n;
reg    HwReg_ColorModeOut_out2_blk_n;
reg    ap_block_state1;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (1'b0 == HwReg_ColorModeOut_out2_full_n) | (1'b0 == HwReg_ColorModeOut_out_full_n) | (1'b0 == HwReg_ColorMode_out1_full_n) | (1'b0 == HwReg_ColorMode_out_full_n) | (1'b0 == HwReg_WidthOut_out_full_n) | (1'b0 == HwReg_WidthIn_out_full_n) | (1'b0 == HwReg_Height_out_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_ColorModeOut_out2_blk_n = HwReg_ColorModeOut_out2_full_n;
    end else begin
        HwReg_ColorModeOut_out2_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((real_start == 1'b0) | (1'b0 == HwReg_ColorModeOut_out2_full_n) | (1'b0 == HwReg_ColorModeOut_out_full_n) | (1'b0 == HwReg_ColorMode_out1_full_n) | (1'b0 == HwReg_ColorMode_out_full_n) | (1'b0 == HwReg_WidthOut_out_full_n) | (1'b0 == HwReg_WidthIn_out_full_n) | (1'b0 == HwReg_Height_out_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_ColorModeOut_out2_write = 1'b1;
    end else begin
        HwReg_ColorModeOut_out2_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_ColorMode_out1_blk_n = HwReg_ColorMode_out1_full_n;
    end else begin
        HwReg_ColorMode_out1_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((real_start == 1'b0) | (1'b0 == HwReg_ColorModeOut_out2_full_n) | (1'b0 == HwReg_ColorModeOut_out_full_n) | (1'b0 == HwReg_ColorMode_out1_full_n) | (1'b0 == HwReg_ColorMode_out_full_n) | (1'b0 == HwReg_WidthOut_out_full_n) | (1'b0 == HwReg_WidthIn_out_full_n) | (1'b0 == HwReg_Height_out_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        HwReg_ColorMode_out1_write = 1'b1;
    end else begin
        HwReg_ColorMode_out1_write = 1'b0;
    end
end
...
assign HwReg_ColorModeOut_out2_din = HwReg_ColorModeOut;

assign HwReg_ColorModeOut_out_din = HwReg_ColorModeOut;

assign HwReg_ColorMode_out1_din = HwReg_ColorMode;

assign HwReg_ColorMode_out_din = HwReg_ColorMode;

assign HwReg_Height_out_din = HwReg_Height;

assign HwReg_WidthIn_out_din = HwReg_WidthIn;
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (1'b0 == HwReg_ColorModeOut_out2_full_n) | (1'b0 == HwReg_ColorModeOut_out_full_n) | (1'b0 == HwReg_ColorMode_out1_full_n) | (1'b0 == HwReg_ColorMode_out_full_n) | (1'b0 == HwReg_WidthOut_out_full_n) | (1'b0 == HwReg_WidthIn_out_full_n) | (1'b0 == HwReg_Height_out_full_n) | (ap_done_reg == 1'b1));
end
...
endmodule //bd_197a_hsc_0_v_hscaler_entry189
