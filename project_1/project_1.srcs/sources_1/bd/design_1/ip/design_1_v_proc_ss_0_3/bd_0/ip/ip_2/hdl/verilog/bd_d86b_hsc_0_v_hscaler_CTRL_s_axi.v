...
// ==============================================================
`timescale 1ns/1ps
module bd_d86b_hsc_0_v_hscaler_CTRL_s_axi
#(parameter
...
// 0x4000 ~
// 0x5fff : Memory 'HwReg_phasesH_V' (3840 * 9b)
...
//------------------------Instantiation------------------
// int_HwReg_hfltCoeff
bd_d86b_hsc_0_v_hscaler_CTRL_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 192 )
) int_HwReg_hfltCoeff (
    .clk0     ( ACLK ),
...
module bd_d86b_hsc_0_v_hscaler_CTRL_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
