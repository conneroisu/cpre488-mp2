...
HD_PWD='C:/Users/jaxie963/Temp/cpre488-mp2/project_1/project_1.runs/bd_d86b_auto_ss_slidr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_d86b_auto_ss_slidr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_d86b_auto_ss_slidr_0.tcl
