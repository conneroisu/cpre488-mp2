...
HD_PWD='C:/Users/jaxie963/Temp/cpre488-mp2/project_1/project_1.runs/bd_18aa_input_size_set_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_18aa_input_size_set_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_18aa_input_size_set_0.tcl
