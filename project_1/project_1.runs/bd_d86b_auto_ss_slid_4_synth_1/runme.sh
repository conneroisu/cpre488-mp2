...
HD_PWD='C:/Users/jaxie963/Temp/cpre488-mp2/project_1/project_1.runs/bd_d86b_auto_ss_slid_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_d86b_auto_ss_slid_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_d86b_auto_ss_slid_4.tcl
