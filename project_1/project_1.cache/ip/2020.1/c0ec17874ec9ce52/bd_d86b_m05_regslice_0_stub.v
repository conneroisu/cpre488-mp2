...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ bd_d86b_m05_regslice_0_stub.v
...
/* synthesis syn_black_box black_box_pad_pin="aclk,aresetn,s_axis_tvalid,s_axis_tready,s_axis_tdata[47:0],s_axis_tstrb[5:0],s_axis_tkeep[5:0],s_axis_tlast,s_axis_tid[0:0],s_axis_tdest[3:0],s_axis_tuser[0:0],m_axis_tvalid,m_axis_tready,m_axis_tdata[47:0],m_axis_tstrb[5:0],m_axis_tkeep[5:0],m_axis_tlast,m_axis_tid[0:0],m_axis_tdest[3:0],m_axis_tuser[0:0]" */;
  input aclk;
  input aresetn;
  input s_axis_tvalid;
