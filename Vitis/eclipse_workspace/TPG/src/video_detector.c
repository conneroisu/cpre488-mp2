 ...
 *
 * @param	VtcDeviceID is the device ID of the Video Timing Controller
 *core. pVtc is a pointer to a VTC instance
 *
...
int vdet_init(XVtc *pVtc, u16 VtcDeviceID) {
  ...
  // phjones update to pass just 1 arg.  XVtc_Enable(pVtc, XVTC_EN_GENERATOR |
  // XVTC_EN_DETECTOR);
  XVtc_Enable(pVtc);
